      ...
      {['D', 'I', 'S', 'C'].map((type) => (
        <div key={type} style={{ maxWidth: '200px', textAlign: 'center' }}>
          <Image src={`/${{
            ...
            S: 'elephant',
            C: 'tiger'
          }[type]}.png`} alt={`${type} Style Coach`} width={120} height={120} />
